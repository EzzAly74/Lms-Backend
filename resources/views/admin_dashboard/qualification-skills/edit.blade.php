...
@section('Page_Title')   {{ __('text.qualification_skills') }} | {{ __('text.edit') }}   @endsection
        ...
        <div class="col-lg-12 mx-auto">
            <div class="breadcrumb d-flex align-items-center justify-content-between">
                <div class="">
                    ...
                    <strong class="text-primary">{{ __('text.edit') }}</strong>
                    <span class="mx-2">-</span>
                            ...
                            <div class="card shadow-none bg-light border">
                                <div class="card-body">
                                    <form class="row g-3" id="validateForm" method="post"
                                          action="{{route('admin.qualification-skills.update', $content->id)}}">
                                        @method('put')
                                        @csrf
