...
> **Context for AI agents:** This skill is used exclusively for the **API layer** (`routes/api.php`, `app/Http/Controllers/Api/`).
> Do **not** apply any of this to the existing MVC controllers or Blade views. See SSOT.md §⚠️ AI Agent Rules.
