...
/**
 * Lightweight list-view resource matching the Figma "Created Quizzes"
 * mini-table: title, course, cohort scope (with pill), question count,
 * total score, due date, status.
 */
class AdminQuizListResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'cohorts'         => $cohorts,
            'questions_count' => (int) ($this->rich_questions_count ?? $this->questions_count ?? 0),
